...
class AggregationLoss(nn.Module):
    ...
    def forward(self, pred_regions, pred_kernels, pred_similarities, gt_polygons, regions_mask, kernels_mask):
        masked_pred_regions = pred_regions * regions_mask
        masked_pred_kernels = pred_kernels * kernels_mask
