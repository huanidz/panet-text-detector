...
from ..heads.PAHead import PAHead

class PANet(nn.Module):
    def __init__(self, channels_scale:int = 128, num_fpem:int = 2, similarity_channels_scale:int = 32):
        ...
        self.head = PAHead(channels_scale=channels_scale, similarity_channels=similarity_channels_scale)
